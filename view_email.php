...
$stmt = db()->prepare("
  SELECT r.id, r.user_id, r.from_email, r.subject, r.body, r.received_at,
         s.status, s.risk_score, s.triggers, s.raw_json
...
$trig   = (string)($email['triggers'] ?? 'None');
...
<div style="max-width:1100px; margin:0 auto; padding:20px;">
  <div class="card">
    <h1 style="margin:0 0 8px 0;"><?= htmlspecialchars((string)$email['subject']) ?></h1>

    <div class="small" style="line-height:1.8;">
      <div><b>From:</b> <?= htmlspecialchars((string)$email['from_email']) ?></div>
      <div><b>Received:</b> <?= htmlspecialchars((string)$email['received_at']) ?></div>
    </div>
  ...
  <div class="card" style="margin-top:16px;">
    ...
    <div class="small" style="margin-top:10px;"><b>Triggers:</b> <?= htmlspecialchars($trig) ?></div>
  </div>

  <div class="btnrow" style="margin-top:14px;">
    <a class="btn secondary" href="inbox.php">← Back to Inbox</a>
